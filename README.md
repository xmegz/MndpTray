...
* Download from GitHub [**Latest**](https://github.com/xmegz/MndpTray/releases/download/v2.3.0/MndpTray.Core.exe)
...
* Ubuntu 20.04, 22.04, 24.04 Debian 10, 12, 13 Linux support
